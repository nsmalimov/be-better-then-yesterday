...
async def handle_intents(user_id, intent_key, db):
    if intent_key == Intents.QUOTE.value:
        ...
        text = "Я умею записывать твои успехи и поражения в течении дня. Вести их учет и выводить статистику. " \
               "А также я умею ваши мотивирующие цитаты."
        response = {
            "response": {
                "text": text,
                "end_session": False
        ...
        text = "Скажите четко и как можно более простыми обещупотребительными словами, " \
               "какую ошибку вы сегодня совершили. А я запишу. Скажите \"Не хочу рассказывать. Это секрет!\", чтобы перестала ждать от вас фразы."
        response = {
            "response": {
                "text": text,
                "end_session": False
        ...
        text = "Скажите четко и как можно более простыми обещупотребительными словами, что было по вашему мнению " \
               "у вас хорошо. А я запишу. Скажите \"Не хочу рассказывать. Это секрет!\", чтобы перестала ждать от вас фразы."
        response = {
            "response": {
                "text": text,
                "end_session": False
